...
> **⚠️ 文档状态**：本文档为**早期设计愿景**（2025 年起草），其中 SurrealDB/Qdrant 数据库、
> 时间序列、zenoh 服务等描述**未在当前代码中实现**。程序性记忆 trigger/action 结构等也与
> 当前代码不同（见 [记忆模型](memory-model.md)）。保留本文档作设计演进参考；当前架构以
> [总体架构](overview.md) 为准。
