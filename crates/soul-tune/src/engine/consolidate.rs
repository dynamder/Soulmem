...
pub struct ConsolidateSuite;

impl TestSuite for ConsolidateSuite {
    ...
    fn run_case(&self, _index: usize) -> TestCaseOutcome {
        TestCaseOutcome {
            case_name: String::from("consolidate-stub"),
...
mod tests {
    ...
    fn test_stub_run_case_not_passed() {
        ...
        assert_eq!(outcome.case_name, "consolidate-stub");
    }
